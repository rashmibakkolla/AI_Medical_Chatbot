...
system_prompt = (
    ...
    "in your response. Your response should be in one long paragraph. "
    "Always answer as if you are responding to a real person. Do not say 'In the image I see' but say 'With what I see'. "
